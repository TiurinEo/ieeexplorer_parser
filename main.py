...
async def parse(number_of_pages: int, query: str,
                output: str, tranlsate: bool = True, id: bool = True, publicationDate: bool = True,
                year_only: bool = True,
                title: bool = True, abstract: bool = True, authors: bool = True):
    start_time = time.time()
    print(
        f'Parsing {number_of_pages} pages of articles,query is {query}, saving to {output}, translating to rus is {tranlsate}')
